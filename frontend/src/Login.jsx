  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Log in to access your personalized dashboard, AI-powered insights, and
          curated nutrition plan.
        </p>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.45)", fontSize: 13 }}>
            <span style={{ color: "#52b788", fontWeight: 700 }}>10,000+</span>{" "}
            users tracking their health
          </p>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              onMouseLeave={(e) => {
                if (!loading) e.target.style.background = "#1a1a2e";
              }}
            >
              {loading ? (
                <>
          ...
          >
            ...
            <span style={{ color: "#52b788", cursor: "pointer" }}>
              Privacy Policy
            </span>
          </p>
        </div>
